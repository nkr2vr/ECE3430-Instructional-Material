...
void ConfigureTimerA(void)
{
	...
	PWM_PERIOD = TIMER_PERIOD;  //2000 cycles * (16 Mhz/8) = 1 ms
...
// 	TACCTL1 = CCIE | OUTMOD_7;          //Interrupt and Output mode 7: reset on CCR1/set on CCR0
	TACCTL1 = OUTMOD_7;                 //Output mode 7: reset on CCR1/set on CCR0
